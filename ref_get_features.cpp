...
///home/aurora/hdd/software/Caffe/caffe-master/examples/people_identity/deploy2.prototxt  /home/aurora/hdd/software/Caffe/caffe-master/examples/people_identity/caffenet_train_iter_150000.caffemodel  1  conv1,fc7,prob,accuracy conv1.dat,fc7.dat,prob.dat,accuracy.dat GPU 0
int main(int argc, char** argv)
{
    ...
    for (size_t i = 0; i < num_features; i++)
    {
        file_names[i] = "/home/aurora/workspace/"+file_names[i];
        fp[i] = fopen(file_names[i].c_str(), "wb");
        LOG(ERROR)<<file_names[i];
    }
